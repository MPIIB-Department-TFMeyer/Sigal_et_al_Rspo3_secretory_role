---
title: "Microarray Data Rspondin KO, Stomach Corpus - Reanalysis with LIMMA"
...
exp_design = read.xlsx("../AllHybs.xlsx",sheetIndex = 1, stringsAsFactors=F)
exp_design = subset(exp_design, Tissue == "Stomach Corpus")
...
sel_cols = c("Scan.ID","Chip.Barcode","dye_swap","Cy3_label","Cy5_label")
tmp = ed[,sel_cols]
...
```{r}
save(ed, RG, MA, MA.n, exp_matrix, file="../../../Data/Processed/Rspo_KO_Corpus_micro_array_preprocessed_data.Rdata")
```
